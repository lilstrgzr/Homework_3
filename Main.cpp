...
int main() {
    ...
    Tree appleTree("Яблоня", 5, 8);


    appleTree.createFruit("Яблоко", 0.10);
    appleTree.createFruit("Яблоко", 0.23);
    appleTree.createFruit("Яблоко", 0.34);
    appleTree.createFruit("Яблоко", 0.47);
    appleTree.createFruit("Яблоко", 0.55);
    appleTree.createFruit("Яблоко", 0.62);
